    ...
    case "reply":
      {
        ...
        if (arg[0] == "unban" || arg[0] == "Unban" || arg[0] == "ub" || arg[0] == "Ub") {
          ...
          return api.sendMessage(`»Notification from Admin«\n\n Your Group Has Been Unbanned And Can Use Bot Again [Contact Bot Admin For Support.]`, idgr, () =>
            api.sendMessage(`${api.getCurrentUserID()}`, () =>
  ...
  switch (args[0]) {
    ...
    default:
      ...
      for (const thread of data) {
	   ...
	   return api.sendMessage(threadList.length != 0 ? api.sendMessage(`🍄There Are Currently ${threadList.length} group\n\n${threadList.join("\n")}`,
          threadID,
          messageID
