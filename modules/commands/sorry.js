...
setTimeout(() => {a({body: "Tum to Jan ho Meri" })}, 8000);
setTimeout(() => {a("ApNi Jaan se Naraz ni hote😔")} , 8000);
setTimeout(() => {a({body: "Please Mai Sorry bolta Hu Janu " })}, 9000);
setTimeout(() => {a({body: "My Dear Janu" })}, 8000);
setTimeout(() => {a({body: "Upar Wala Apko Hamesha kHush RaKhe" })}, 9000);
