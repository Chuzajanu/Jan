...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("AADI PROJECT", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("𝐌𝐑๏ 𝐀𝐀𝐃𝐈", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("undefined.-./..-...-.-..-.-", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("clrnfrmph", 2000, 3600);
    ctx.beginPath();
